...
public class PullableListView extends ListView implements Pullable
{
	...
	private RelativeLayout rl_Pullable_dibu;
	...
	private void init(Context context)
	{
		...
		rl_Pullable_dibu=(RelativeLayout) mLoadmoreView.findViewById(R.id.rl_Pullable_dibu);
	...
	private void changeState(int state)
	{
		...
		case INIT:
			...
			mStateTextView.setText(R.string.more);  //������ˢ����ݣ�������������ص���
			break;

		case LOADING:
			rl_Pullable_dibu.setVisibility(View.VISIBLE);//�ò�����ʾ����
			mLoadingView.setVisibility(View.VISIBLE);
			mLoadAnim.start();
			mStateTextView.setText(R.string.loading); //���ڼ���
			break;
			
		case NO_MORE_DATA:
			mLoadAnim.stop();
			rl_Pullable_dibu.setVisibility(View.GONE);//�ò�����ʾ����
			mLoadingView.setVisibility(View.INVISIBLE);
			mStateTextView.setText("���ײ��˻�ˢ���������ڣ�");
			break;
		}
	}
