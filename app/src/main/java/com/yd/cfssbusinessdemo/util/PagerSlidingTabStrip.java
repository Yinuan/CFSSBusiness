 ...
 */
/**
 * 类  描   述:自定义顶部多Tab导航tab和导航条
 * 类  名   称:PagerSlidingTabStrip
 * 所属包名 :com.yd.widget.pagerslidingtabstrip
 * 创   建  人:pchp
 * 创建时间 :2016年4月27日 下午4:22:27
 */
public class PagerSlidingTabStrip extends HorizontalScrollView
{
	...
	private int tabBackgroundResId = R.drawable.bg_scrolltab;
...
//				tab.setTextSize(TypedValue.COMPLEX_UNIT_PX, tabTextSize);//原来源码是这样的px单位
				tab.setTextSize(TypedValue.COMPLEX_UNIT_SP, tabTextSize);//我这里直接改成sp单位用
